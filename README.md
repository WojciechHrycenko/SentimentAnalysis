# Sentiment Analysis
- Final grade: home-taken project (70% weight) and its presentation (30% weight).
- Minimum requirement to pass: 50% (overall).
- The project and its presentation are to be completed as a home assignment, in groups of up to two persons.
- Presentations are scheduled for: Jan 14, Jan 21 (first take), and Feb 20 - Mar 1 (second take).
...
Presentation Details
 ...
 The evaluation shall be based on:
 - The correctness of the content presented,
 - Responses to questions if asked,
 - The structure and organisation of the presentation,
 - Adherence to the imposed time limit.
